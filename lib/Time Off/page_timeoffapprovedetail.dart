               ...
               child: Column(
                 children: [
                   ...
                   Align(alignment: Alignment.centerLeft,child: Padding(padding: EdgeInsets.only(top: 5),
                     child: Text(timeoff_number.toString(), style: GoogleFonts.nunito(fontSize: 18,fontWeight: FontWeight.bold)),))
                 ],
               ),
             ),
           ),),
                ...
                Padding(
                  ...
                  child:  Row(
                    ...
                    children: [
                      ...
                      Text(timeoff_description.toString(),
                          style: GoogleFonts.nunito(fontSize: 14)),],
                  ),
                ),
                                  ...
                                  child: Column(
                                    children: [
                                      Align(alignment: Alignment.centerLeft,child: Text("Approval Note",
                                        style: GoogleFonts.nunitoSans(fontWeight: FontWeight.bold,fontSize: 17),)),
                                      ...
                                      Container(
                                        ...
                                        ElevatedButton(
                                          ...
                                          child: Text("Approve", style: TextStyle(color: HexColor("#fffdfc"),fontWeight: FontWeight.bold),),
                                          onPressed: () {
                                            showDialog1(context);
                                          },
                                        ),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          ElevatedButton(
                                            ...
                                            child: Text("Reject", style: TextStyle(color: HexColor("#ffeaef"),fontWeight: FontWeight.bold),),
                                            onPressed: () {
